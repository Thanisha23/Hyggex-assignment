...
const Dashboard:React.FC = () => {
  ...
  return (
    <div>
    <h1 className='bg-clip-text text-transparent bg-gradient-to-b from-[#06286E] to-[#164EC0] text-[19px] md:text-[32px] pt-[44px] md:pt-[64px] font-bold font-montserrat pb-[43px] md:pb-[56px]'>Relations and Functions ( Mathematics )</h1>
   ...
   {sections.map((item,index) => (
    ...
    {/*  */}
    <div className='mx-auto mt-[32px] w-[422px] h-[280px] md:w-[712px] md:h-[393.13px] rounded-[40px] bg-gradient shadow-xl flex justify-center items-center relative '>
   ...
   <div className='w-[612px] h-[60px] pt-[32px] relative '>
        ...
        <img className='md:w-[50px] md:h-[50px] w-[40px] h-[40px] absolute top-6 md:top-4 right-[120px] md:right-[170px]' src="./rightarrow.png" alt="rightarrow" />
        <img className='md:w-[50px] md:h-[50px] w-[40px] h-[40px] absolute top-6 md:top-4 left-[120px] md:left-[170px] ' src="./leftarrow.png" alt="leftarrow" />
   ...
   <div className='md:pt-[91.80px] pt-[80px] flex justify-center items-center gap-[6rem] md:gap-[40rem]'>
    ...
    <div className='flex justify-center items-center gap-[8px]'>
        ...
        <h2 className='font-inter text-[15px] md:text-[20px] font-semibold bg-clip-text text-transparent bg-gradient-to-b from-[#06286E] to-[#164EC0]'>Create Flashcard</h2>
    </div>
   </div>
    </div>
  )
